...
// The architectural wiring is in mission_coordinator_node_base.hpp/.cpp, regenerated
// on every pipeline run.
#include "autonomous_ground_robot/mission_coordinator_node_base.hpp"

class MissionCoordinator : public MissionCoordinatorBase
{
public:
  using MissionCoordinatorBase::MissionCoordinatorBase;
