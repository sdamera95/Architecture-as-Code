...
// The architectural wiring is in depth_camera_driver_node_base.hpp/.cpp, regenerated
// on every pipeline run.
#include "ground_robot_with_nav2/depth_camera_driver_node_base.hpp"

class DepthCameraDriver : public DepthCameraDriverBase
{
public:
  using DepthCameraDriverBase::DepthCameraDriverBase;
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<DepthCameraDriver>();
