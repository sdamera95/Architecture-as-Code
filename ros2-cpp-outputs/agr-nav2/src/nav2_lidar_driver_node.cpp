...
// The architectural wiring is in nav2_lidar_driver_node_base.hpp/.cpp, regenerated
// on every pipeline run.
#include "ground_robot_with_nav2/nav2_lidar_driver_node_base.hpp"

class Nav2LidarDriver : public Nav2LidarDriverBase
{
public:
  using Nav2LidarDriverBase::Nav2LidarDriverBase;
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<Nav2LidarDriver>();
