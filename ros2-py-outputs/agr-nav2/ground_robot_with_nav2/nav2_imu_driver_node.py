...
nav2_imu_driver_node_base.py, which is regenerated on every pipeline run.
"""
import rclpy

from .nav2_imu_driver_node_base import Nav2ImuDriverBase


class Nav2ImuDriver(Nav2ImuDriverBase):
