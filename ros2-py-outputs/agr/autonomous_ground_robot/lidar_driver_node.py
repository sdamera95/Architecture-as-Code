"""LidarDriver — node implementation. EDIT ME.
...
lidar_driver_node_base.py, which is regenerated on every pipeline run.
"""
import rclpy

from .lidar_driver_node_base import LidarDriverBase


class LidarDriver(LidarDriverBase):
