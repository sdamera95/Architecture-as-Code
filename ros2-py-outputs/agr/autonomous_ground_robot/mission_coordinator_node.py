"""MissionCoordinator — node implementation. EDIT ME.
...
mission_coordinator_node_base.py, which is regenerated on every pipeline run.
"""
import rclpy

from .mission_coordinator_node_base import MissionCoordinatorBase


class MissionCoordinator(MissionCoordinatorBase):
    """mission_coordinator application logic."""
